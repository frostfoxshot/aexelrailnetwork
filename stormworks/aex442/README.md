...
---
Note: This is related to the following vehicle: [Steam Workshop Link](https://steamcommunity.com/sharedfiles/filedetails/?id=3669180247)
---
...
### New in v1.1  
- Added lever to blend auxiliary motors with main motors  
  - Only to be used for cargo operations  
  - Not recommended for regular passenger use  
...
### New in v1.1  
- Complete passenger cabin redesign  
...
A detailed PDF manual will be available soon. Check the [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=3669180247) or our Github for updates.
...
- Added lever in engine room to blend auxiliary motors with main motors  
  - Only to be used for cargo operations  
  - Not recommended for regular passenger use  
